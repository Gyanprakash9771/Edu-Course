...
export default function FooterSection({ isMobile }) {
  return (
    <Box bg="#000000" px={{ base: 4, md: 10 }} py={{ base: 16, md: 20 }} mt={20}>
      ...
      <HStack flexWrap="wrap" justifyContent="space-between">
        ...
        >
          ...
          <Text color="gray.300">About Us</Text>
          <Text color="gray.300">Latest News</Text>
          <Text color="gray.300">Term Conditions</Text>
          <Text color="gray.300">Our Courses</Text>
          <Text color="gray.300">Our Team</Text>
        </VStack>
        ...
        >
          ...
          <Text color="gray.300">Tutorials</Text>
          <Text color="gray.300">Documentation</Text>
          <Text color="gray.300">Privacy Policy</Text>
          <Text color="gray.300">FAQs</Text>
          <Text color="gray.300">Support</Text>
        </VStack>
